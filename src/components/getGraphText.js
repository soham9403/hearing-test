        ...
        return (
            <>
                <ul style={{ justifyContent: "flex-start" }} className="df  row p-primary column">
                    ...
                    <li style={fromPdf ? { justifyContent: "flex-start", textAlign: "left",marginLeft:"20px", color: "#000" } : { justifyContent: "flex-start", textAlign: "left" }} className='h6 ml-1 pb-3 pr-3  row  font-intern bold-2 text-2-primary'>
